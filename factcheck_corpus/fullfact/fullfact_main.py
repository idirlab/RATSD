...
from utils.fullfact_xpath import fullfact_xpath

current_time = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
print("-----" * 10)
print("Fullfact timestamp:", current_time)

def main():
    """ Corner cases: https://www.fullfact.org/health/double-mutants/
    """
    base_url = "https://www.fullfact.org"
    new_data, page_num, cont, publisher = [], 1, True, 'fullfact'
